...
| <a id='haDes%3AnumberOfAudioChannels'></a>aantal audiotracks <br> <small>[(haDes:numberOfAudioChannels)](https://data.hetarchief.be/ns/description/numberOfAudioChannels)</small> | Het aantal audiokanalen die een audiospoor bevat. | `0..1` | [`xsd:nonNegativeInteger`](http://www.w3.org/2001/XMLSchema#nonNegativeInteger)  |
