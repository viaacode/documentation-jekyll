...
--------|----------|
 ...
 IANA mime type|[Internet Assigned Numbers Authority media types](https://www.iana.org/assignments/media-types/media-types.xhtml)|
 Integer   |[Arbitrary-size non negative integer numbers](https://www.w3.org/TR/xmlschema-2/#nonNegativeInteger)|
 String    |[Character strings](https://www.w3.org/TR/xmlschema-2/#string)|
 UUID      |[Universally Unique Identifier](https://datatracker.ietf.org/doc/html/rfc4122)|
 URI       |Absolute or relative [Uniform Resource Identifier](https://datatracker.ietf.org/doc/html/rfc3986) or [Internationalized Resource Identifier](https://datatracker.ietf.org/doc/html/rfc3987)|
 URL       |[Uniform Resource Locator](https://datatracker.ietf.org/doc/html/rfc1738)|
...
It is important to note that the package *mets.xml* file does not record the internal structure of the different representations in the **/representations** directory.
